  ...
  return (
    <>
      ...
      <div className="form">
        ...
        <Input className="loans" placeholder="Current Loans" />
        <Input className="debt" placeholder="Credit Card Debt" />
        <Input className="obligations" placeholder="Other Obligations" />
        </Space>
      </div>
    </>
  );
